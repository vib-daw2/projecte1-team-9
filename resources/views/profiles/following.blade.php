...
<div class="w-full min-h-screen bg-gray-50 flex justify-center flex-row items-start px-12 py-8">
    <div class="w-full max-w-5xl flex flex-col justify-center items-center">
        ...
        @if ($users->count() == 0)
            <div class="w-full flex justify-center items-center text-2xl font-medium mt-8">
                No users found
            </div>
        @endif
        <div id="userlist" class="max-w-5xl mt-4 w-full mx-auto flex-col justify-start items-center gap-3">
                            ...
                            <form method="POST" action="/follow/{{ $user->id }}"
                                ...
                                @if ($following)
                                    <button
                                        ...
                                        <svg class="group-hover:block hidden lucide lucide-user-x-2"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M14 19a6 6 0 0 0-12 0" />
