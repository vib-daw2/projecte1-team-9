    ...
    <div class="mt-4 flex justify-between w-full gap-2 px-4 text-lg font-base">
        ...
        <form method="POST" action="/follow/{{$user->id}}"
            ...
            <button
                ...
                <svg class="group-hover:hidden block" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <svg class="group-hover:block hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                     viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                     stroke-linejoin="round">
                    <path d="M14 19a6 6 0 0 0-12 0"/>
                    <circle cx="8" cy="9" r="4"/>
